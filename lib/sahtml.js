...
(function() {
  ...
  SAHtml = (function() {
    ...
    function SAHtml(str) {
      ...
      this.encoder = new AllHtmlEntities;
      this.xhtml = false;
    }
    ...
    SAHtml.prototype.decodeText = function(text) {
      return this.encoder.decode(text).replace(/[\n\r\t\f ]+/g, ' ');
    };
    ...
    SAHtml.prototype.next = function() {
      ...
      if (this.state === SAHtml.STATE_TAG_DEF) {
        ...
        if (chr === "/") {
          ...
          this.state = SAHtml.STATE_TAG_CONTENT;
          if (this.currentTag && this.noHtmlContentTags[this.currentTag]) {
            return {
              type: SAHtml.ENTITY_TAG_DEF_END,
              pos: spos
            };
    ...
    SAHtml.prototype.render = function(entities) {
      var encoder, entity, result, _i, _len;
      ...
      for (_i = 0, _len = entities.length; _i < _len; _i++) {
        ...
        switch (entity.type) {
          ...
          case SAHtml.ENTITY_STRING:
            result.push(encoder.encode(entity.value));
            break;
